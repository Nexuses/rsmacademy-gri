  ...
  return (
    <div className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="mb-12">
          <h2 className="text-4xl font-bold mb-4">Modern skills need a modern learning approach</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {approaches.map((approach, index) => (
            <div key={index} className="group cursor-pointer">
              <div className="mb-4 p-3 rounded-full inline-block border border-gray-200 group-hover:border-green-500 transition-colors">
                {approach.icon}
              </div>
        ...
        <div className="bg-green-800 text-white rounded-xl overflow-hidden shadow-xl">
          <div className="p-8">
